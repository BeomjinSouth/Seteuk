...
- 공식 교육과정 PDF의 중학교 변화와 관계 영역에서 `문자의 사용과 식`, `일차방정식`, `좌표평면과 그래프`, `9수02-01`부터 `9수02-07`까지를 확인했다.
...
- `문자를 이름표로만 해석하는 오류`, `동류항이 아닌 항을 합치는 오류`, `이항 부호 오류`, `축 위의 점과 사분면 혼동`처럼 교과서 본문이나 학생 오답에서 자주 드러나는 미시 항목은 공식 문서의 용어 체계와 성취수준 수행 진술에 근거한 파일럿 노드로 두고, 교과서 원본 확보 후 쪽수 근거를 보강해야 한다.
