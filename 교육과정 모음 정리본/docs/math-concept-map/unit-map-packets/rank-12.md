...
| m1_expr_polynomial__prerequisite_for__m1_calc_collect_like_terms_polynomial | 다항식 | prerequisite_for | 다항식에서 동류항 모으기 | high | official_dual_source |
...
| m1_expr_polynomial__prerequisite_for__m1_calc_monomial_times_polynomial_distribution | 다항식 | prerequisite_for | 단항식을 다항식에 분배하기 | medium | official_dual_source |
...
| m1_expr_polynomial__prerequisite_for__m1_calc_polynomial_add_sub_principle | 다항식 | prerequisite_for | 다항식의 덧셈과 뺄셈 원리 | high | official_dual_source |
