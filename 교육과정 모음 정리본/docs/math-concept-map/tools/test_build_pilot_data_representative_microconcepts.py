...
class DataRepresentativeMicroconceptTests(unittest.TestCase):
    def test_mean_microconcepts_are_explicit(self) -> None:
        ...
        expected = {
            ...
            "m1_data_mean_as_fair_share": ("자료 하나당 평균적인 값", "sub_concept", "medium"),
            "m1_data_mean_unit_interpretation": ("평균의 단위 해석", "procedure", "low"),
        }
        ...
        self.assertIn("m1_data_mean_as_fair_share", concepts["m1_data_mean_unit_interpretation"]["prerequisite_ids"])
    ...
    def test_median_and_mode_microconcepts_are_explicit(self) -> None:
        ...
        expected = {
            ...
            "m1_data_median_odd_position_rule": ("홀수 개 자료의 중앙 위치 규칙", "property", "low"),
            "m1_data_median_even_position_rule": ("짝수 개 자료의 두 가운데 위치 규칙", "property", "low"),
            "m1_data_two_middle_values": ("두 가운데 값", "sub_concept", "low"),
            ...
            "m1_data_mode_frequency_table": ("최빈값 도수표 표현", "representation", "low"),
        ...
        self.assertIn("m1_data_median_odd_position_rule", concepts["m1_data_median_odd_count"]["prerequisite_ids"])
        self.assertIn("m1_data_median_even_position_rule", concepts["m1_data_median_even_count"]["prerequisite_ids"])
        self.assertIn("m1_data_two_middle_values", concepts["m1_data_median_even_count"]["prerequisite_ids"])
    ...
    def test_representative_value_selection_context_is_explicit(self) -> None:
        ...
        expected = {
            ...
            "m1_data_representative_value_situation_interpretation": ("상황에 맞게 대푯값 해석하기", "procedure", "medium"),
            "m1_data_mean_suitable_context": ("평균이 적절한 경우", "property", "low"),
            "m1_data_median_suitable_context": ("중앙값이 적절한 경우", "property", "low"),
            "m1_data_mode_suitable_context": ("최빈값이 적절한 경우", "property", "low"),
        ...
        self.assertIn("[9수04-01]", source_locators(concepts["m1_data_representative_value_situation_interpretation"]))
    ...
    def test_representative_value_edges_are_directional(self) -> None:
        ...
        expected_edges = [
            ...
            "m1_data_mean_as_fair_share__used_in__m1_data_mean",
            "m1_data_mean_unit_interpretation__used_in__m1_data_representative_value_situation_interpretation",
            "m1_data_ordered_data_for_median__used_in__m1_data_median",
            "m1_data_middle_position__used_in__m1_data_median",
            "m1_data_median_odd_position_rule__used_in__m1_data_median_odd_count",
            "m1_data_median_even_position_rule__used_in__m1_data_median_even_count",
            "m1_data_two_middle_values__used_in__m1_data_median_even_count",
            ...
            "m1_data_mode_selection__represented_by__m1_data_mode_frequency_table",
            "m1_data_mode_frequency_table__used_in__m1_data_mode_selection",
            ...
            "m1_data_representative_value_situation_interpretation__used_in__m1_data_choose_representative_value",
            "m1_data_mean_suitable_context__used_in__m1_data_choose_representative_value",
            "m1_data_median_suitable_context__used_in__m1_data_choose_representative_value",
            "m1_data_mode_suitable_context__used_in__m1_data_choose_representative_value",
    ...
    def test_representative_value_noisy_edges_are_absent(self) -> None:
        ...
        noisy_edges = [
            ...
            "m1_data_median_odd_position_rule__prerequisite_for__m1_data_median_even_count",
            "m1_data_median_even_position_rule__prerequisite_for__m1_data_median_odd_count",
            "m1_data_mean_as_fair_share__prerequisite_for__m1_data_median",
            "m1_data_mode_frequency_table__represented_by__m1_data_mode_selection",
        ]
