...
|---|---|---|---|---|
| m1_mis_trig_angle_scope | 삼각비 각의 범위를 0도~90도 밖으로 확장하는 오류 | misconception_risk | official_single_source | 교육과정 유의사항에 근거한 범위 관리 노드다. |
| m1_mis_trig_relation_scope | 삼각비 사이의 관계를 교육과정 범위로 오해하는 오류 | misconception_risk | official_single_source | 교육과정 유의사항은 삼각비 사이의 관계는 다루지 않는다고 명시한다. |
...
| m1_geo_trig_unit__contains__m1_geo_right_triangle | 삼각비 | contains | 직각삼각형 | high | official_dual_source |
...
| m1_geo_pythagorean_unit__prerequisite_for__m1_geo_trig_unit | 피타고라스 정리 | prerequisite_for | 삼각비 | high | official_dual_source |
