...
|---|---|---|---|---|
| m1_mis_circumcenter_incenter | 외심과 내심을 혼동하는 오류 | misconception_risk | official_dual_source |  |
| m1_mis_proof_observation | 관찰 결과와 증명을 같은 수준의 근거로 보는 오류 | misconception_risk | official_dual_source |  |
...
| m1_geo_perpendicular_bisector__used_in__m1_geo_circumcenter | 수직이등분선 | used_in | 외심 | high | official_dual_source |
