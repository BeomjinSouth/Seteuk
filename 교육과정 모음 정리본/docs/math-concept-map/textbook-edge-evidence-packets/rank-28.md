...
| m1_geo_triangle_construction__prerequisite_for__m1_geo_congruence | intra_unit | 삼각형의 작도 | prerequisite_for | 합동 | high | prerequisite_ref;textbook_page_refs | Find textbook sequencing or prior-knowledge evidence for the prerequisite relation. | 2 |
