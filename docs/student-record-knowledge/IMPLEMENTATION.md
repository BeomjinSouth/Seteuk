...
- `globals.css` loads the local MapleStory font, maps `--font-body`, `--font-display`, `--font-soft`, and compatibility Korean font variables to MapleStory, and applies it as the default body/control font across the app
