...
| m1_expr_substitution__used_in__m1_eq_solution_check | 대입 | used_in | 해의 확인 | high | official_dual_source |
| m1_quad_eq_solving__used_in__m1_eq_solution_check | 이차방정식 풀기 | used_in | 해의 확인 | high | official_dual_source |
| m1_eq_unknown__contrasts_with__m1_term_variable | 미지수 | contrasts_with | 변수 | medium | official_dual_source |
