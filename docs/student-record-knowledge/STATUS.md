...
- 2026-05-17: deployed the growth student card cookie badge fix to Vercel production as `dpl_3riuKmGBxEwWhKfueB3Gbq3antD6`; verified the live alias `https://seteuk-zgyj.vercel.app` is Ready and `/observation-board-2` returns 200
