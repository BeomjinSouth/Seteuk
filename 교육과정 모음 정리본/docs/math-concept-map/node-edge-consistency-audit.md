...
- total issues: 49
- missing_edge_for_related_id: 49
...
| missing_edge_for_related_id | m1_quad_eq_double_root | 중근 | related_ids | m1_quad_eq_real_solution_scope | 이차방정식의 실수 해 범위 | related_edge |  |
| missing_edge_for_related_id | m1_quad_eq_real_solution_scope | 이차방정식의 실수 해 범위 | related_ids | m1_quad_eq_root_formula | 근의 공식 | related_edge |  |
| missing_edge_for_related_id | m1_quad_eq_unit | 이차방정식 | related_ids | m1_factor_factorization | 인수분해 | related_edge |  |
| missing_edge_for_related_id | m1_quad_func_tech_tool_graph | 공학 도구로 이차함수 그래프 탐구하기 | related_ids | m1_func_tech_tool_graph | 공학 도구로 함수 그래프 탐구하기 | related_edge |  |
| missing_edge_for_related_id | m1_repr_everyday_language | 일상 언어 | related_ids | m1_expr_letter | 문자 | related_edge |  |
| missing_edge_for_related_id | m1_repr_expression | 식 | related_ids | m1_expr_value | 식의 값 | related_edge |  |
| missing_edge_for_related_id | m1_system_two_variable_linear_equation | 미지수가 2개인 일차방정식 | related_ids | m1_coord_graph_unit | 좌표평면과 그래프 | related_edge |  |
| missing_edge_for_related_id | m1_system_two_variable_linear_equation | 미지수가 2개인 일차방정식 | related_ids | m1_func_equation_relation | 일차함수와 미지수가 2개인 일차방정식의 관계 | related_edge |  |
| missing_edge_for_related_id | m1_term_variable | 변수 | related_ids | m1_prop_direct_proportion | 정비례 | related_edge |  |
| missing_edge_for_related_id | m1_term_variable | 변수 | related_ids | m1_prop_inverse_proportion | 반비례 | related_edge |  |
