...
- concept: 51개
  - 네 자리 이하의 수: 20개
  - 두 자리 수 범위의 덧셈과 뺄셈: 20개
  - 한 자리 수의 곱셈: 11개
- edge: 50개 (contains 14, prerequisite_for 10, related_to 3, represented_by 6, used_in 17)
- concept type 분포: core_concept 9, procedure 16, property 6, representation 6, sub_concept 9, term 5
