...
- observation board 2 mentor display scope: the selected class scope controls the mentor/mentee cards, activity table, and roster tray; the visible-student count setting expands the default mentor pairs beyond the initial six students when selected
