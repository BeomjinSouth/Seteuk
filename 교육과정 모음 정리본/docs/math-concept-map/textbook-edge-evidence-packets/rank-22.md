...
| m1_func_eq_relation_unit__contains__m1_func_intersection_point | intra_unit | 일차함수와 일차방정식의 관계 | contains | 교점 | medium | structure_ref;textbook_page_refs | Find textbook structure evidence for the containment relation. | 1 |
...
| m1_func_intersection_point__prerequisite_for__m1_func_system_solution_from_intersection | intra_unit | 교점 | prerequisite_for | 교점으로 연립일차방정식의 해 말하기 | high | prerequisite_ref;textbook_page_refs | Find textbook sequencing or prior-knowledge evidence for the prerequisite relation. | 2 |
...
| m1_func_two_linear_graphs__prerequisite_for__m1_func_intersection_point | intra_unit | 두 일차함수의 그래프 | prerequisite_for | 교점 | medium | prerequisite_ref;textbook_page_refs | Find textbook sequencing or prior-knowledge evidence for the prerequisite relation. | 1 |
...
| m1_coord_coordinate__prerequisite_for__m1_func_intersection_point | cross_unit | 좌표 | prerequisite_for | 교점 | medium | prerequisite_ref;textbook_page_refs | Find textbook sequencing or prior-knowledge evidence for the prerequisite relation. | 1 |
