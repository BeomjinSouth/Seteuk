...
- unit groups: 34
- concept evidence rows: 520
- edge evidence rows: 2670
- pending textbook evidence rows: 3190
- low confidence concept/edge rows: 571

## Unit Workplan

| rank | grade | domain | unit | tier | workplan score | concepts pending/low | edges pending/low/cross | next action | packets |
|---:|---|---|---|---|---:|---:|---:|---|---|
| 1 | 중1(교육과정 학년군: 중1-3) | 변화와 관계 | 좌표평면과 그래프 | highest | 477 | 43/9 | 234/75/72 | fill_low_confidence_concept_and_edge_evidence | rank-01.md; rank-01.md |
