...
- 2026-05-17: pushed GitHub commit `3ea5383` (`style: apply maplestory default font`) to `main`; Vercel production deployment `dpl_3X3RQVM55nojZNFmH3PYNbbmdBjn` is Ready and the live alias `https://seteuk-zgyj.vercel.app` points to `https://seteuk-zgyj-jgilakwy9-beomjinsouths-projects.vercel.app`. Vercel project settings were not changed.
