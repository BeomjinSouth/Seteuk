...
- 교과서 PDF가 추가되기 전에는 `research-report-source-review.*`의 high/medium priority row를 검토해, 공식 연구보고서 맥락이 실제 concept 정의·예시 평가도구·채점 기준 근거인지 확인하고 source ref 또는 confidence 보강 여부를 별도로 결정한다.
