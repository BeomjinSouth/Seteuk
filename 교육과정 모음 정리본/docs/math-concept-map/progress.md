...
- 학년군 사이 데이터셋 경계를 잇는 cross-dataset edge(예: 초5-6 약수·배수→중1 소인수분해, 중3 이차함수→공통수학1 이차방정식·이차함수 관계)를 문서의 직접 연계 서술 기반으로 추가하는 방법을 정한다. 확보 시 시각화에 학년군 간 미시 선수 화살표로 반영할 수 있다.
